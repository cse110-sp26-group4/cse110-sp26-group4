...
### Instruction Files
When configuring an agent environment (e.g. `AGENTS.md`, `CLAUDE.md`, `GEMINI.md`), you should include a reference to `BATON_AGENT_RULES.md`, found [here](../source/templates/BATON_AGENT_RULES.md).
